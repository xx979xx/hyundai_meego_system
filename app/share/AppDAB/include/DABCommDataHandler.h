...
private:
        ...
        void SPIFirstPacket(const quint8 *buffer, quint8 index, quint16 dataTotalLength, unsigned char frameposition);
        void SPILastPacket(const quint8 *buffer, quint8 index, quint16 dataTotalLength, unsigned char frameposition);
