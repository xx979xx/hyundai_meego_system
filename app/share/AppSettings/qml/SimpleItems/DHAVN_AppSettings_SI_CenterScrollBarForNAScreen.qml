...
Item{
    ...
    property int leftCount: ( rScrollCurrentValue < 0 ) ? ( 5 + rScrollCurrentValue ) : 5
    ...
    function calc_Left_SliderBar( mouseValue )
    {
        if( mouseValue < 50){
            ...
            leftCount = ( mouseValue / 50 )

        }
        setValueText( 5 - leftCount, false )
        switchPressed()
                ...
                Rectangle{
                    ...
                    Image{
                        ...
                        function getLeftSliderImg()
                        {
                            ...
                            if( leftCount == 0){
                                if( bFocused )
                                    return HM.const_URL_IMG_GENERAL_SCREEN_SLIDER_BG_F
                                else
                                    return HM.const_URL_IMG_GENERAL_SCREEN_SLIDER_BG_S
                            }
                            else{
                                if( leftCount > index ){
                                    return HM.const_URL_IMG_GENERAL_SCREEN_SLIDER_BG_N
                                }
                                else{
                                    if( bFocused )
                                        return HM.const_URL_IMG_GENERAL_SCREEN_SLIDER_BG_F
