...
DHAVN_AppSettings_FocusedItem{
    ...
    Timer {
        ...
        onTriggered:
        {
            ...
            SettingsStorage.SaveSetting( radioList.currentindex, Settings.DB_KEY_SPEED_DEPENDENT_PE )
            EngineListener.NotifyApplication( Settings.DB_KEY_SPEED_DEPENDENT_PE, radioList.currentindex, "", UIListener.getCurrentScreen() )
        }
    }
