...
//    clip:true
    ...
    ListModel{
        id:headunitData
        ListElement {   name:"iBox" ; /*value: system; subname:"";check:"off"; gridId:0*/ }
        ListElement {   name:"AMP" ; /*subname:SystemInfo.GetKernelVersion(); check:"off";gridId:1*/  }
        ListElement {   name:"CCP" ; /*subname:SystemInfo.GetBuildDate(); check:"off"; gridId:2*/ }
        ListElement{ name: "RRC";}
        ListElement{ name: "Front Monitor";}
        ListElement{ name: "Rear Monitor";}
        ListElement{ name: "Radio Antenna";}
        ListElement{ name: "DMB Antenna";}
        ListElement{ name: "GPS Antenna";}
        ListElement{ name: "Modem Antenna";}
        ListElement{ name: "XM/SIRIUS Antenna";}
        ListElement{ name: "USB_F";}
        ListElement{ name: "iPod_F";}
        ListElement{ name: "USB_R";}
        ListElement{ name: "iPod_R";}
        ListElement{ name: "AUX";}
    ...
    ListView{
        ...
        anchors.fill: parent;
        model: headunitData
        delegate: Engineer_HardwareRightDelegateConnect{
