...
*/
    ...
    Image {
        ...
        Text {
            text: stringInfo.str_Device_Name_Bottom + " : "+ BtCoreCtrl.m_strConnectedDeviceName
            x: 50
            y: 35 - 16
            width: 1180
            height: 32
        ...
        Item {
            ...
            Item {
                ...
                Text {
                    ...
                    anchors.right: idRecentCountAuto.left
        ...
        Item {
            ...
            Item {
                ...
                Text {
                    ...
                    height: 40
                    color: colorInfo.bandBlue
                    anchors.right: idRecentCountMal.left
                    anchors.rightMargin: 4
                    horizontalAlignment: Text.AlignRight
                    verticalAlignment: Text.AlignVCenter
                }
        ...
        Item {
            ...
            Item {
                ...
                Text {
                    ...
                    height: 40
                    color: colorInfo.bandBlue
                    anchors.right: idContactsCountAuto.left
                    anchors.rightMargin: 4
                    horizontalAlignment: Text.AlignRight
                    verticalAlignment: Text.AlignVCenter
                }
        ...
        Item {
            ...
            Item {
                ...
                Text {
                    ...
                    height: 40
                    color: colorInfo.bandBlue
                    anchors.right: idContactsCountMal.left
                    anchors.rightMargin: 4
                    horizontalAlignment: Text.AlignRight
                    verticalAlignment: Text.AlignVCenter
                }
        ...
        Item {
            ...
            Item {
                ...
                Text {
                    ...
                    height: 40
                    color: colorInfo.bandBlue
                    anchors.right: idContactsUpdate.left
                    anchors.rightMargin: 4
                    anchors.left: idTextProgress.right
                    anchors.leftMargin: (2000 <= BtCoreCtrl.m_nCountContactsList) ? 8 : 4   //2000개 이상일 때, 간격 조절
                    horizontalAlignment: Text.AlignRight
                    verticalAlignment: Text.AlignVCenter
                }
