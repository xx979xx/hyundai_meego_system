/**
 * /BT/Common/PopupLoader/BtPopupContactDownloadFailed.qml
 *
 */
import QtQuick 1.1
...
//        BtCoreCtrl.invokeSetRequestForegroundTTSPopup(false);
    ...
    onPopupFirstBtnClicked: {
        console.log("DownloadRequestState = " + BtCoreCtrl.invokeGetDownloadRequestState());
        clickCheck = true;
//        if(true == BtCoreCtrl.invokeGetDownloadRequestState()) {
             ...
             * reDownload == false
             */
            console.log("BtCoreCtrl.invokeRequestPBAP(BtCoreCtrl.invokeGetConnectedDeviceID(), true, false, 3 /* PBAP_DOWNLOAD_REQUEST_DO_NOTHING */) Call");
//__IQS_16MY__
//            BtCoreCtrl.invokeRequestPBAP(BtCoreCtrl.invokeGetConnectedDeviceID(), true, false, 3 /* PBAP_DOWNLOAD_REQUEST_DO_NOTHING */);
            BtCoreCtrl.invokeRequestPBAP(BtCoreCtrl.invokeGetConnectedDeviceID(), false, true, 3 /* PBAP_DOWNLOAD_REQUEST_DO_NOTHING */);

//                } else {
//                    console.log("BtCoreCtrl.invokeTrackerDownloadPhonebook()");
