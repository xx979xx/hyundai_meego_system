...
enum unspec {
  ...
  UNSPEC_TAN = 54,
  UNSPEC_FXAM = 55,
  UNSPEC_FRNDINT_FLOOR = 56,
  UNSPEC_FRNDINT_CEIL = 57,
  UNSPEC_FRNDINT_TRUNC = 58,
  UNSPEC_FRNDINT_MASK_PM = 59,
  UNSPEC_FIST_FLOOR = 60,
  UNSPEC_FIST_CEIL = 61,
  UNSPEC_SINCOS_COS = 62,
  UNSPEC_SINCOS_SIN = 63,
  UNSPEC_XTRACT_FRACT = 64,
  UNSPEC_XTRACT_EXP = 65,
  UNSPEC_FSCALE_FRACT = 66,
  UNSPEC_FSCALE_EXP = 67,
  UNSPEC_FPREM_F = 68,
  UNSPEC_FPREM_U = 69,
  UNSPEC_FPREM1_F = 70,
  UNSPEC_FPREM1_U = 71,
  ...
  UNSPEC_SP_SET = 74,
  UNSPEC_SP_TEST = 75,
  UNSPEC_SP_TLS_SET = 76,
  UNSPEC_SP_TLS_TEST = 77,
  UNSPEC_ROUND = 78,
  UNSPEC_CRC32 = 79,
  UNSPEC_BEXTR = 80,
  UNSPEC_PDEP = 81,
  ...
  UNSPEC_CAST = 124,
  UNSPEC_VTESTP = 125,
  UNSPEC_VCVTPH2PS = 126,
  UNSPEC_VCVTPS2PH = 127,
  UNSPEC_VPERMSI = 128,
  UNSPEC_VPERMDF = 129,
  UNSPEC_VPERMSF = 130,
  UNSPEC_VPERMTI = 131,
