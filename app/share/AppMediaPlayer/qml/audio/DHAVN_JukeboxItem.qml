...
Item
{
    ...
    function categoryTabHandler(index, isCopyMode, callFromCategory)
    {
        ...
        //EngineListenerMain.qmlLog("JukeboxItem.qml", "categoryTab was pressed currentCategory = "+ currentCategory+"=>"+categoryModel.get(index).cat_id) // modified by sangmin.seol 2014.09.12 reduce high log // modified by sangmin.seol 2014.06.02 add high level log
...
//{modified by aettie 2013.01.16 for ISV 68135/68124
    ListModel
    {
        ...
        ListElement
        {
                categoryName: QT_TR_NOOP("STR_MEDIA_FOLDER")
                categoryImage_s: ""
                categoryImage_n: ""
