...
MComp.MAppMain {
    ...
    MComp.MComponent{
        ...
        onBackKeyPressed:{
            ...
            if(isMapCareEx)
            {
                console.log("[QML] Dealer Mode -> Dynamic: onBackKeyClicked -----------")
                mainViewState = "MapCareMainEx"
                setMapCareUIScreen("", true)
        ...
        MComp.MMainButton{
            ...
            onClickOrKeySelected: {
                ...
                UIListener.MapCareDynamicMenu(EngineerData.Dynamic_MapCare_DMB);
        ...
        onHomeKeyPressed: {
            ...
            if(isMapCareEx)
            {
                console.log("[QML]Return HOME Screen :: Dealer Mode -> Dynamic:")
                mainViewState = "MapCareMainEx"
                setMapCareUIScreen("", true)
                //idMapCareMainView.forceActiveFocus()
                mainViewState="Main"
