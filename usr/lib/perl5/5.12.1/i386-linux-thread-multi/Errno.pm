...
"i386-linux-thread-multi-2.6.37-4-default" or
	die "Errno architecture (i386-linux-thread-multi-2.6.37-4-default) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
