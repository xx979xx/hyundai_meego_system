...
unless(defined(&_SYS_CDEFS_H)) {
    ...
    if( &__GNUC_PREREQ (4,3) || (defined (&__GNUC_RH_RELEASE__)  && (defined(&__GNUC__) ? &__GNUC__ : undef) == 4 && (defined(&__GNUC_MINOR__) ? &__GNUC_MINOR__ : undef) == 1 && (defined(&__GNUC_PATCHLEVEL__) ? &__GNUC_PATCHLEVEL__ : undef) == 2 && (defined(&__GNUC_RH_RELEASE__) ? &__GNUC_RH_RELEASE__ : undef) >= 31)) {
	eval 'sub __warndecl {
	    my($name, $msg) = @_;
    ...
    if(!defined (&__cplusplus) ||  &__GNUC_PREREQ (4,3) || (defined (&__GNUC_RH_RELEASE__)  && (defined(&__GNUC__) ? &__GNUC__ : undef) == 4 && (defined(&__GNUC_MINOR__) ? &__GNUC_MINOR__ : undef) == 1 && (defined(&__GNUC_PATCHLEVEL__) ? &__GNUC_PATCHLEVEL__ : undef) == 2 && (defined(&__GNUC_RH_RELEASE__) ? &__GNUC_RH_RELEASE__ : undef) >= 31)) {
