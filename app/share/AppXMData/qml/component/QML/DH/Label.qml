    ...
    Component.onCompleted: {
        if(txtAlign==="Center") {
            ...
            if(bgImage ==="") {
                ...
                fontY = fontY== 0 ? (parent.height - bgTxt.height)/2: fontY;
                width=bgTxt.width;
                height=bgTxt.height;
            }
            else {
    ...
    Connections {
        ...
        onTextChanged: {
            if( container.text != "" )
            {
                if(txtAlign==="Center") {
                    if(bgImage ==="") {
                        fontX=(container.parent.width - bgTxt.width)/2;
                        fontY = fontY== 0 ? (container.parent.height - bgTxt.height)/2: fontY;
                        width=bgTxt.width;
                        height=bgTxt.height;
                    }
                    else {
                    ...
                    if(bgImage ==="") {
                        fontX=(container.parent.width - bgTxt.width);
                        fontY=(container.parent.height - bgTxt.height)/2;
                        width=bgTxt.width;
                        height=bgTxt.height;
                    }
                    else {
