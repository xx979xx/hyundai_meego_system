        ...
        DHAVN_AppSettings_FocusedItem{
            ...
            DHAVN_AppSettings_SI_RadioList{
                ...
                onIndexSelected:
                {
                    ...
                    var prevLanguageType = SettingsStorage.languageType
                    if(prevLanguageType != radiomodel.get(radiolist.currentindex).item_id)
                    {
                        SettingsStorage.languageType = radiomodel.get(radiolist.currentindex).item_id
                        SettingsStorage.SaveSetting( radiomodel.get(radiolist.currentindex).item_id,
                                                    Settings.DB_KEY_LANGUAGE_TYPE )
                        EngineListener.ChangeLanguage(radiomodel.get(radiolist.currentindex).item_id)
                        ...
                        {
                            var keypadIndex;
                            if(radiomodel.get(radiolist.currentindex).item_id == Settings.SETTINGS_LANGUAGE_FR)
                                keypadIndex = 3
                            else if(radiomodel.get(radiolist.currentindex).item_id == Settings.SETTINGS_LANGUAGE_DE)
                                keypadIndex = 2
                            else
                                keypadIndex = 0
