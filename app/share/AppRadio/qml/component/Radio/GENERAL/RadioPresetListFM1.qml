...
FocusScope {
    ...
    visible: idAppMain.globalSelectedBand == "FM1"
    //enabled: idAppMain.globalSelectedBand == "FM1"
...
//            else if(value == 0 && idRadioPresetListFM1.requestStopSearch == true ){
//                console.log("onChangeSearchState requestStopSearch: " + idRadioPresetListFM1.requestStopSearch + idRadioPresetListFM1.requestStopIndex);
//                idRadioPresetListFM1.requestStopSearch = false;
//                QmlController.setPresetIndex(QmlController.radioBand,idRadioPresetListFM1.requestStopIndex)//QmlController.setPresetIndexFM1(idRadioPresetListFM1.requestStopIndex);
//                QmlController.presetRecall(idRadioPresetListFM1.requestStopIndex - 1,idRadioPresetListFM1.channelChangedFreq); // micom has index from 0 so it need to -1
//                idChListView.currentItem.calculateFrequencyInView();
//                idRadioPresetListFM1.requestStopIndex   = -1;
//                idRadioPresetListFM1.channelChangedFreq = "";
//            }
...
// modified by qutiguy 2014.01.22 : modified position.
    ...
    /////////////////////////////////////////////////////////////////
    // idRadioPresetListFM1 functions
    ...
    function changeState(){
        ...
        if(idAppMain.globalSelectedBand =="FM1"){
            ...
            if((QmlController.presetIndexFM1 -1) < 0xF0){ // JSH Jog focus
                ...
                idRadioPresetListFM1.selectedItem = QmlController.presetIndexFM1 -1
            }
            else{
                idAppMain.alreadySaved         = 0
                idRadioPresetListFM1.selectedItem = QmlController.presetIndexFM1
            }
        }
        ...
        if((!idAppMain.doNotUpdate) && (idAppMain.state == "AppRadioMain" || (!idAppMain.globalMenuAnimation))){
            if(idRadioPresetListFM1.selectedItem < 12)
                idRadioMain.jogFocusState =  "PresetList"
            else
                idRadioMain.jogFocusState =  "FrequencyDial"
        }
...
//      }
    ...
    onActiveFocusChanged: { // JSH jog focus
        ...
        console.log("========================> PresetList onActiveFocusChanged :: ",idRadioPresetListFM1.activeFocus,idRadioMain.jogFocusState)
        if(idRadioMain.jogFocusState == "PresetList" && idAppMain.state == "AppRadioMain" && (!idRadioPresetListFM1.activeFocus))
            focus = true;
