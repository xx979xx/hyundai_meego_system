...
enum opt_code
{
  ...
  OPT_m128bit_long_double = 985,             /* -m128bit-long-double */
  OPT_m32 = 986,                             /* -m32 */
  OPT_m3dnow = 987,                          /* -m3dnow */
  OPT_m3dnowa = 988,                         /* -m3dnowa */
  OPT_m64 = 989,                             /* -m64 */
  OPT_m80387 = 990,                          /* -m80387 */
  OPT_m8bit_idiv = 991,                      /* -m8bit-idiv */
  OPT_m96bit_long_double = 992,              /* -m96bit-long-double */
  OPT_mabi_ = 993,                           /* -mabi= */
  OPT_mabm = 994,                            /* -mabm */
  OPT_maccumulate_outgoing_args = 995,       /* -maccumulate-outgoing-args */
  OPT_maes = 996,                            /* -maes */
  OPT_malign_double = 997,                   /* -malign-double */
  OPT_malign_functions_ = 998,               /* -malign-functions= */
  OPT_malign_jumps_ = 999,                   /* -malign-jumps= */
  OPT_malign_loops_ = 1000,                  /* -malign-loops= */
  OPT_malign_stringops = 1001,               /* -malign-stringops */
  OPT_mandroid = 1002,                       /* -mandroid */
  OPT_march_ = 1003,                         /* -march= */
  OPT_masm_ = 1004,                          /* -masm= */
  OPT_mavx = 1005,                           /* -mavx */
  OPT_mavx2 = 1006,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1007,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1008,  /* -mavx256-split-unaligned-store */
  OPT_mbionic = 1009,                        /* -mbionic */
  OPT_mbmi = 1010,                           /* -mbmi */
  OPT_mbmi2 = 1011,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1012,                  /* -mbranch-cost= */
  OPT_mcld = 1013,                           /* -mcld */
  OPT_mcmodel_ = 1014,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1015, */                    /* -mcpu= */
  OPT_mcrc32 = 1016,                         /* -mcrc32 */
  OPT_mcx16 = 1017,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1018,            /* -mdispatch-scheduler */
  OPT_mf16c = 1019,                          /* -mf16c */
  OPT_mfancy_math_387 = 1020,                /* -mfancy-math-387 */
  OPT_mfentry = 1021,                        /* -mfentry */
  OPT_mfma = 1022,                           /* -mfma */
  OPT_mfma4 = 1023,                          /* -mfma4 */
  OPT_mforce_drap = 1024,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1025,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1026,                       /* -mfpmath= */
  OPT_mfsgsbase = 1027,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1028, */              /* -mfused-madd */
  OPT_mglibc = 1029,                         /* -mglibc */
  OPT_mhard_float = 1030,                    /* -mhard-float */
  OPT_mieee_fp = 1031,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1032,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1033,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1034,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1035, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1036,         /* -mlarge-data-threshold= */
  OPT_mlwp = 1037,                           /* -mlwp */
  OPT_mlzcnt = 1038,                         /* -mlzcnt */
  OPT_mmmx = 1039,                           /* -mmmx */
  OPT_mmovbe = 1040,                         /* -mmovbe */
  OPT_mms_bitfields = 1041,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1042,            /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 1043,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1044,                  /* -mno-push-args */
  OPT_mno_red_zone = 1045,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1046,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1047,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1048,                          /* -mpc32 */
  OPT_mpc64 = 1049,                          /* -mpc64 */
  OPT_mpc80 = 1050,                          /* -mpc80 */
  OPT_mpclmul = 1051,                        /* -mpclmul */
  OPT_mpopcnt = 1052,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1053,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1054,     /* -mpreferred-stack-boundary= */
  OPT_mpush_args = 1055,                     /* -mpush-args */
  OPT_mrdrnd = 1056,                         /* -mrdrnd */
  OPT_mrecip = 1057,                         /* -mrecip */
  OPT_mrecip_ = 1058,                        /* -mrecip= */
  OPT_mred_zone = 1059,                      /* -mred-zone */
  OPT_mregparm_ = 1060,                      /* -mregparm= */
  OPT_mrtd = 1061,                           /* -mrtd */
  OPT_msahf = 1062,                          /* -msahf */
  OPT_msoft_float = 1063,                    /* -msoft-float */
  OPT_msse = 1064,                           /* -msse */
  OPT_msse2 = 1065,                          /* -msse2 */
  OPT_msse2avx = 1066,                       /* -msse2avx */
  OPT_msse3 = 1067,                          /* -msse3 */
  OPT_msse4 = 1068,                          /* -msse4 */
  OPT_msse4_1 = 1069,                        /* -msse4.1 */
  OPT_msse4_2 = 1070,                        /* -msse4.2 */
  OPT_msse4a = 1071,                         /* -msse4a */
  /* OPT_msse5 = 1072, */                    /* -msse5 */
  OPT_msseregparm = 1073,                    /* -msseregparm */
  OPT_mssse3 = 1074,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1075,               /* -mstack-arg-probe */
  OPT_mstackrealign = 1076,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1077,            /* -mstringop-strategy= */
  OPT_mtbm = 1078,                           /* -mtbm */
  OPT_mtls_dialect_ = 1079,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1080,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1081,                         /* -mtune= */
  OPT_muclibc = 1082,                        /* -muclibc */
  OPT_mveclibabi_ = 1083,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1084,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1085,                    /* -mvzeroupper */
  OPT_mx32 = 1086,                           /* -mx32 */
  OPT_mxop = 1087,                           /* -mxop */
  OPT_n = 1088,                              /* -n */
