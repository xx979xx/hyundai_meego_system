...
DHAVN_AppSettings_FocusedItem{
    ...
    function setVisualCueOnMenu( index )
    {
        ...
        {
        case APP.const_SETTINGS_GENERAL_LANGUAGE                       : setVisualCue(true, false, false, true); visualCue.longkey_other = true;  break
        case APP.const_SETTINGS_GENERAL_KEYPAD                         : setVisualCue(true, false, false, true); visualCue.longkey_other = true;  break
        case APP.const_SETTINGS_GENERAL_DISTANCE_UNIT                  : setVisualCue(true, false, false, true); visualCue.longkey_other = true;  break
        case APP.const_SETTINGS_GENERAL_PHONE_PRIORITY                 : setVisualCue(true, false, false, true); visualCue.longkey_other = true;  break
        case APP.const_SETTINGS_GENERAL_PHOTO_FRAME                    : setVisualCue(true, false, false, true); visualCue.longkey_other = true;  break
        case APP.const_SETTINGS_GENERAL_APPROVAL                       : setVisualCue(true, false, false, false);
            ...
            break
        case APP.const_SETTINGS_GENERAL_REAR_SEAT_CONTROL_MENU         : setVisualCue(true, false, false, true); visualCue.longkey_other = false;  break
    ...
    DHAVN_AppSettings_FocusedItem{
        ...
        DHAVN_AppSettings_Menu{
            ...
            onSelectItem:
            {
                ...
                EngineListener.printLogMessage("SettingsStorage.isLanguagedChanged !!!!!!: " + SettingsStorage.isLanguageChanged )
                if( !SettingsStorage.isLanguageChanged )
                {
                    if(!bJog)
                    {
                        content_general.hideFocus()
            ...
            onFocus_visibleChanged:
            {
                ...
                //EngineListener.printLogMessage("[General]onFocus_visibleChanged: " + focus_visible)
                if(focus_visible)
                {
        ...
        DHAVN_AppSettings_FocusedLoader{
            ...
            onVisibleChanged:
            {
                ...
                {
                    if( status != Loader.Ready )
                        // 2014.02.24 DH_PE Language sort by alphabetical order
                        //source = "DHAVN_AppSettings_General_Language.qml"
                        source = "DHAVN_AppSettings_General_Language_Alphabetical.qml"
                }
                else
                {
                    hideFocus()
            ...
            onVisibleChanged:
            {
                if ( visible )
                {
                    if( status != Loader.Ready )
                    {
                        ...
                        if(isAgreement10 == true)
                        {
                            source = "DHAVN_AppSettings_General_Approval_NA.qml"
                        }
                        else
                        {
                            source = "DHAVN_AppSettings_General_Approval.qml"
                        }
						//added for NA/CH Agreement Spec Modify(time 10, default on)
                    }
                }
    ...
    ListModel{
        ...
        Component.onCompleted:
        {
           ...
           // added for Media Notification(Idea Bank)
            ...
            if ( currentRegion == 1 || currentRegion == 6 )
            {
                general_list_model.append({"itemNum": APP.const_SETTINGS_GENERAL_DISTANCE_UNIT ,"isCheckNA": false, "isChekedState": true, "isDimmed": false, "isPopupItem":false, "dbID": 0,
                                              name: QT_TR_NOOP("STR_SETTING_GENERAL_DISTANCE"),
                                              nameOfState: APP.const_APP_SETTINGS_GENERAL_STATE_DISNANCE_UNIT})
            }

            if (currentRegion == 0)
            {
                general_list_model.append({"itemNum": APP.const_SETTINGS_GENERAL_PHONE_PRIORITY ,"isCheckNA": false, "isChekedState": false, "isDimmed": false, "isPopupItem":false, "dbID": 0,
                                              name: QT_TR_NOOP("STR_SETTING_VOICE_PHONE_PRIORITY"),
                                              nameOfState: APP.const_APP_SETTINGS_GENERAL_STATE_PHONE_PRIORITY})
            }
    ...
    states:
        ...
        State{
            name: APP.const_APP_SETTINGS_GENERAL_STATE_DISNANCE_UNIT
            PropertyChanges { target: generalMenu; selected_item: getItemIndex(APP.const_SETTINGS_GENERAL_DISTANCE_UNIT) }
        },
        State{
    ...
    Connections{
        target: root
        onSetDefaultFocusLanguageChanged:{
            EngineListener.printLogMessage("onSetDefaultFocusLanguageChanged...");
            visualCue.releaseLeft()
        }
    }
    ...
    Connections{
        ...
        onIsAccStatusOnChanged:
        {
            ...
            EngineListener.printLogMessage("onIsAccStatusOnChanged: " + EngineListener.isAccStatusOn )
            if(SettingsStorage.currentRegion != 7){
                EngineListener.printLogMessage("onIsAccStatusOnChanged: Update GUI");
                var index = -1
                index = getItemIndex(APP.const_SETTINGS_GENERAL_LOCK_REAR_MONITOR)
