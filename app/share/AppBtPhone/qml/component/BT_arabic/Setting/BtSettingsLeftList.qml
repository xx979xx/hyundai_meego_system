/**
 * /BT_arabic/Setting/BtSettingsLeftList.qml
 *
 */
import QtQuick 1.1
...
MComp.MComponent
{
    ...
    Flickable {
        ...
        MComp.MButtonHaveTicker {
            ...
            firstTextStyle: stringInfo.fontFamilyRegular   //"HDR"(settingCurrentIndex == 0)? stringInfo.fontFamilyBold : stringInfo.fontFamilyRegular  //"HDR"
            firstTextElide: "Left"
        ...
        MComp.MButtonHaveTicker {
            ...
            firstTextFocusPressColor: colorInfo.brightGrey
            firstTextSelectedColor: colorInfo.bandBlue //RGB(124,189,255)
            firstTextStyle: stringInfo.fontFamilyRegular   //"HDR"(settingCurrentIndex == 1)? stringInfo.fontFamilyBold : stringInfo.fontFamilyRegular   //"HDR"
            firstTextElide: "Left"
            firstTextAlies: "Right"
        ...
        MComp.MButtonHaveTicker {
            ...
            firstTextFocusPressColor: colorInfo.brightGrey
            firstTextSelectedColor: colorInfo.bandBlue //RGB(124,189,255)
            firstTextStyle: stringInfo.fontFamilyRegular   //"HDR"(settingCurrentIndex == 2)? stringInfo.fontFamilyBold : stringInfo.fontFamilyRegular  //"HDR"
            firstTextElide: "Left"
            firstTextAlies: "Right"
        ...
        MComp.MButtonHaveTicker {
            ...
            firstTextFocusPressColor: colorInfo.brightGrey
            firstTextSelectedColor: colorInfo.bandBlue //RGB(124,189,255)
            firstTextStyle: stringInfo.fontFamilyRegular   //"HDR"(settingCurrentIndex == 3)? stringInfo.fontFamilyBold : stringInfo.fontFamilyRegular  //"HDR"
            firstTextElide: "Left"
            firstTextAlies: "Right"
        ...
        MComp.MButtonHaveTicker {
            ...
            firstTextFocusPressColor: colorInfo.brightGrey
            firstTextSelectedColor: colorInfo.bandBlue //RGB(124,189,255)
            firstTextStyle: stringInfo.fontFamilyRegular   //"HDR"(settingCurrentIndex == 4)? stringInfo.fontFamilyBold : stringInfo.fontFamilyRegular   //"HDR"
            firstTextElide: "Left"
            firstTextAlies: "Right"
