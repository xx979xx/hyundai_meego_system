...
Item
{
   ...
   function checked()
   {
      // EngineListener.qmlLog( "SongItem:  checked()" )
   ...
   Image
   {
      ...
      anchors { left: parent.left; top: parent.top }
      anchors.leftMargin: FM.const_APP_FILE_MANAGER_AUDIO_SONG_ICON_LEFT_MERGIN
      anchors.topMargin: FM.const_APP_FILE_MANAGER_AUDIO_LIST_ITEM_ICON_TOP_MERGIN
      source: isCurPlayed ? RES.const_APP_FILE_MANAGER_AUDIO_SONG_ICON_LISTPLAY_URL : RES.const_APP_FILE_MANAGER_AUDIO_SONG_ICON_LISTMUSIC_URL
   }
   ...
   Text
   {
      ...
      anchors.leftMargin: FM.const_APP_FILE_MANAGER_AUDIO_SONG_TEXT_LEFT_MERGIN
