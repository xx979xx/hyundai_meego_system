    ...
    function changeListViewPosition(index)
    {
        ...
        else if(index > 5 && index < 12)
        {
            if(index >= list_view.currentTopIndex && index < list_view.currentTopIndex+6)
                ...
                list_view.positionViewAtIndex(list_view.count-6, ListView.Beginning)
        }
    }
    ...
    Component{
        ...
        DHAVN_AppSettings_FocusedItem{
            ...
            Item{
                ...
                anchors.rightMargin: APP.const_APP_SETTINGS_B_MENU_ITEM_LINE_LEFT_MARGIN
                ...
                ScrollingTicker {
                    ...
                    anchors.right: parent.right
                    anchors.rightMargin: (isVideoMode) && (!isBrightEffectShow) ? 13 : 14
                ...
                Image{
                    id: image_checkbox
                    anchors.right:parent.right
                    anchors.rightMargin: (item.__is_dimmed) ? 470 : 469
