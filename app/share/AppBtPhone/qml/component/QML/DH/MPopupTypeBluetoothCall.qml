...
MPopup
{
    ...
    Component.onCompleted: {
        if(true == idMPopupTypeBluetoothCall.visible) {
            ...
            idText1.font.pointSize = "" != BtCoreCtrl.m_strPhoneName1 ? 70 : (stringInfo.str_Spam == popupFirstText && hiddenText.paintedWidth > 540) ? 45 : 60;
        }
    ...
    Image {
        ...
        MCallPopupButton {
            ...
            firstTextWidth: 210
            firstTextHeight: 36
            firstTextSize: (13 == gLanguage) ? 33 : 36
        ...
        Text {
            ...
            width: 540
            height: "" != BtCoreCtrl.m_strPhoneName1 ? 70 : 60
            font.pointSize: "" != BtCoreCtrl.m_strPhoneName1 ? 70 : (stringInfo.str_Spam == popupFirstText && hiddenText.paintedWidth > 540)? 45 : 60;
            font.family: stringInfo.fontFamilyRegular    //"HDR"
            horizontalAlignment: Text.AlignLeft
            verticalAlignment: Text.AlignVCenter
            color: colorInfo.brightGrey
            elide: stringInfo.str_Spam == popupFirstText ? Text.ElideNone : Text.ElideRight
            wrapMode: stringInfo.str_Spam == popupFirstText ? Text.WordWrap : Text.NoWrap
        }
