...
MComponent{
    ...
    property bool btDuringCallWidth: false;
    ...
    MButton{
        ...
        fgImageX: popupBtnCnt == 1 ? 778-780 : popupBtnCnt == 2 ? 774-780 : popupBtnCnt == 3 ? 766 - 780 : 763 - 780
        fgImageY: popupBtnCnt == 1 ? 117 - 18 : popupBtnCnt == 2 ? 50 - 18 : popupBtnCnt == 3 ? 44 - 25 : 31 - 25
        fgImageWidth: 69
        fgImageHeight: 69
...
//        secondTextVisible: popupFirstBtnText2Line != ""
    ...
    MButton{
        ...
        fgImageX: popupBtnCnt == 2 ? 774-780 : popupBtnCnt == 3 ? 766 - 780 : 763 - 780
...
//        secondTextVisible: popupSecondBtnText2Line != ""
    ...
    MButton{
        ...
        fgImageX: popupBtnCnt == 3 ? 766 - 780 : 763 - 780
...
//        secondTextVisible: popupFourthBtnText2Line != ""
    ...
    Text{
        ...
        width: btDuringCallWidth ? 685 : 654; height: 32
        font.pixelSize: 32
    ...
    Text{
        ...
        x: popupTextX;
        y: popupLineCnt == 2 ? popupBgImageY + 130 + popupTextSpacing - 32/3 : popupLineCnt == 3 ? popupBgImageY + 108 + popupTextSpacing - 32/2 : popupBgImageY + 86 + popupTextSpacing - 32/2
        width: 654; height: 32
        font.pixelSize: 32
        font.family: systemInfo.font_NewHDR
        horizontalAlignment: Text.AlignLeft
