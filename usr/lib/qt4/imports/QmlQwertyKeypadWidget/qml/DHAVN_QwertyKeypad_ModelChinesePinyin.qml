...
Item{
    ...
    property list<ListElement> keypad:[
        ...
        ListElement{
            ...
            property string btn_text: "STR_KEYPAD_TYPE_WORD"
            property int btn_keycode: Qt.Key_A //Dummy
            property int btn_fontSize: 50
        ...
        ListElement{
            ...
            property variant trn_index:[14,15,16, 32,32,33, 23,25, 23,25]
            property int btn_width: 120
            property int btn_height: 86
            property string btn_suffix: 'kor_character'
        ...
        ListElement{
            ...
            property variant trn_index:[15,16,17, 32,33,34, 24,26, 24,26]
            property int btn_width: 120
            property int btn_height: 86
            property string btn_suffix: 'kor_character'
        ...
        ListElement{
            ...
            property variant trn_index:[17,18,27, 34,35,27, 26,27, 26,28]
        ...
        ListElement{
            ...
            property int btn_width: 120
            property int btn_height: 86
            property string btn_suffix: 'kor_etc'          // Chinese
        ...
        ListElement{
            ...
            property int btn_width: 247
            property int btn_height: 86
            property string btn_suffix: 'eu_space'
            property string btn_text: " "
        ...
        ListElement{
            ...
            property int btn_width: 247
            property int btn_height: 86
            property string btn_suffix: 'chn_done'
            property string btn_text: ""
