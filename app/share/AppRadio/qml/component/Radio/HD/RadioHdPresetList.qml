...
//            else if(value == 0 && idRadioHdPresetList.requestStopSearch == true ){
//                console.log("onChangeSearchState requestStopSearch: " + idRadioHdPresetList.requestStopSearch + idRadioHdPresetList.requestStopIndex);
//                idRadioHdPresetList.requestStopSearch = false;
//                //QmlController.setPresetIndexFM1(idRadioHdPresetList.requestStopIndex); // JSH 121109 comment ==> presetRecall
//                QmlController.presetRecall(idRadioHdPresetList.requestStopIndex - 1,idRadioHdPresetList.channelChangedFreq,idRadioHdPresetList.channelChangedSps); // micom has index from 0 so it need to -1
//                idChListView.currentItem.calculateFrequencyInView();
//                idRadioHdPresetList.requestStopIndex   = -1;
//                idRadioHdPresetList.channelChangedFreq = "";
//                idRadioHdPresetList.channelChangedSps  = 0xFF;
//            }
            ...
            if(value){ // search start
                ...
                if((idRadioHdMain.jogFocusState != "PresetList") && (value == 7)){
                    //idRadioHdPresetList.forceActiveFocus(); // , JSH 131106 deleted
                    idRadioHdMain.jogFocusState = "PresetList";
                }
    ...
    function changeState(){
        ...
        idRadioHdPresetList.selectedItem = 0xFF;

        if(idAppMain.globalSelectedBand =="FM1"){////if(idAppMain.globalSelectedBand =="FM"){
                    ...
                    if(QmlController.getHDRadiobutton()){
                        if((idChListView.currentItem.presetSpsNum - 1) ==  QmlController.toFlag(QmlController.getHDRadioCurrentSPS())){
                            ...
                            && (QmlController.getRadioDisPlayType())){
                                ...
                                idRadioHdPresetList.selectedItem = QmlController.presetIndexFM1 -1;
                            }
            ...
            if(QmlController.radioBand != 0x02)
                return;
            if((QmlController.presetIndexFM2 -1) < 0xF0 ){
                if(idChListView.currentIndex != QmlController.presetIndexFM2 -1)
                ...
                if(idChListView.currentItem == null){
                    ...
                    console.log("function changeState(){ ================> FM2 :: ",
                                QmlController.presetIndexFM2 -1,idChListView.currentIndex,
                                idChListView.currentItem.presetSpsNum -1 ,
                                QmlController.toFlag(QmlController.getHDRadioCurrentSPS()))

                    if(QmlController.getHDRadiobutton()){
                        if((idChListView.currentItem.presetSpsNum - 1) ==  QmlController.toFlag(QmlController.getHDRadioCurrentSPS())){
                            if(idChListView.currentItem.presetStationName == QmlController.getHDRadioSIS() && (QmlController.getRadioDisPlayType())){
                                //idAppMain.alreadySaved = 1; // JSH 121012 (alreadySaved) not used
                                idRadioHdPresetList.selectedItem = QmlController.presetIndexFM2 -1;
                            }
                            else if(!QmlController.getRadioDisPlayType()){
                                //idAppMain.alreadySaved = 1; // JSH 121012 (alreadySaved) not used
                                idRadioHdPresetList.selectedItem = QmlController.presetIndexFM2 -1;
            ...
            if(QmlController.radioBand != 0x03)
                return;
            if(QmlController.presetIndexAM -1 < 0xF0){
                if(idChListView.currentIndex != QmlController.presetIndexAM -1)
                ...
                if(idChListView.currentItem == null){
                    ...
                    console.log("function changeState(){ ================> AM :: ",
                                idChListView.currentItem.presetSpsNum -1 ,
                                QmlController.toFlag(QmlController.getHDRadioCurrentSPS()))
                    ...
                    if(QmlController.getHDRadiobutton()){
                        if((idChListView.currentItem.presetSpsNum - 1) ==  QmlController.toFlag(QmlController.getHDRadioCurrentSPS())){
                            if(idChListView.currentItem.presetStationName == QmlController.getHDRadioSIS() && (QmlController.getRadioDisPlayType())){
                                //idAppMain.alreadySaved = 1;// JSH 121012 (alreadySaved) not used
                                idRadioHdPresetList.selectedItem = QmlController.presetIndexAM -1;
                            }
                            else if(!QmlController.getRadioDisPlayType()){
                                //idAppMain.alreadySaved = 1;// JSH 121012 (alreadySaved) not used
                                idRadioHdPresetList.selectedItem = QmlController.presetIndexAM -1;
        ...
        if((!idAppMain.doNotUpdate) && ((idAppMain.state == "AppRadioHdMain")
            ...
            //else
            if(QmlController.getRadioDisPlayType() < 2){
                if(idRadioHdPresetList.selectedItem < 12)
                    idRadioHdMain.jogFocusState =  "PresetList"
                else
                    idRadioHdMain.jogFocusState =  "FrequencyDial"
            }
