...
//    }
    ...
    RadioFmFrequencyDial{
        ...
        x: 691; y: systemInfo.headlineHeight-1-systemInfo.statusBarHeight
...
//        KeyNavigation.left: idRadioPresetList
    ...
    //    Image {
    //        id: imgSaveBgDim
    //        x: idRadioPresetList.x; y: idRadioPresetList.y ;
    //        width: systemInfo.lcdWidth//-delegateWidth
    //        height: idRadioPresetList.height
    //        source: imageInfo.imgFolderRadio + "bg_dim.png"
    //        //opacity: 0.6
    ...
    ////////////////////////////////////////////////////////////////////////
    //****************************** # Preset Save & EDIT , Dim Background Image #
    // modified by qutiguy 2014.01.22 : modified dim image & position.
    Image {
        id: imgSaveBgDim
        x: 0; y: 0; z:-1
        ...
        case "PresetList"    :{
            if(globalSelectedBand == "FM1")
            {
                if(!idRadioPresetListFM1.activeFocus){
                    idRadioPresetListFM1.focus = true;
                    //UIListener.writeToLogFile("jogFocus idRadioPresetListFM1 " + idRadioPresetListFM1.activeFocus + idRadioPresetListFM1.focus);
            ...
            else if(globalSelectedBand == "FM2")
            {
                if(!idRadioPresetListFM2.activeFocus){
                    idRadioPresetListFM2.focus = true;
            ...
            else
            {
                if(!idRadioPresetListAM.activeFocus){
                    idRadioPresetListAM.focus = true;
