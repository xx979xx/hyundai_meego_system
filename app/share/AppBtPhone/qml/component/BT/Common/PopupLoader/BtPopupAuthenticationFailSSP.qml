/**
 * /BT/Common/PopupLoader/BtPopupAuthenticationFailSSP.qml
 *
 */
import QtQuick 1.1
...
MComp.MPopupTypeText
{
    ...
    popupLineHeight: gLanguage == 22 ? 0.85 : gLanguage == 21 ? 0.8 : 1
    ...
    popupFirstText: {
        switch(UIListener.invokeGetCountryVariant()) {
            ...
            case 6: // CANADA
                stringInfo.str_Authentication_Fail_Message_CA;
                break;
