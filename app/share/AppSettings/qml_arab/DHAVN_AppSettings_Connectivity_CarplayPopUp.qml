...
DHAVN_AppSettings_FocusedItem{
    ...
    PopUpText{
        ...
        title: QT_TR_NOOP("STR_SETTING_CONNECTIVITY_CARPLAY_POPUP_TITLE_INFO")
        ...
        onBtnClicked:
        {
            ...
            case "OkId":
            {
                closePopUp(true, Settings.SETTINGS_CONNECTIVITY_CARPLAY_POPUP)
            }
            break

            case "CancelId":
            {
                closePopUp(false, Settings.SETTINGS_CONNECTIVITY_CARPLAY_POPUP)
            }
            break
            }
    ...
    ListModel{
        id: messageModel
        ListElement{
            msg: QT_TR_NOOP("STR_SETTING_CONNECTIVITY_CARPLAY_POPUP_INFO")
        }
    }
}
