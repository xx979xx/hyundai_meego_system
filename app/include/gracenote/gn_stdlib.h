...
/*
 *	gn_stdlib.h - Abstraction of limited subset of stdlib functions.
 */

#ifndef	_GN_STDLIB_H_
#define _GN_STDLIB_H_
...
/* Converts the initial part of the string in s to gn_int32_t
...
/* Converts the initial part of the string in s to a gn_uint32_t
 * value according to the given base, which must be between
