...
FocusScope {
    ...
    onVisibleChanged: {
        if (visible) {
            ...
            z = 0;
            currentTopIndex = 0
            listView_frontInit.positionViewAtIndex(0, ListView.Beginning)
        }
    }
    ...
    ListModel {
        ...
        Component.onCompleted:{
            ...
            listModel_frontInit.append({name: QT_TR_NOOP("STR_CAMERA_SETRVIEW9")})
    ...
    Component {
        ...
        MButton {
            ...
            Row {
                ...
                Image {
                    source: {
                        ...
                        else if (index==1) systemInfo.imageInternal+"ico_car_view_02.png"
                        else if (index==2) systemInfo.imageInternal+"ico_car_view_03.png"
                        else if (index==3) systemInfo.imageInternal+"ico_car_view_04.png"
                        else if (index==4) systemInfo.imageInternal+"ico_car_view_05.png"
                    }
                    anchors.verticalCenter: parent.verticalCenter
                }
                ...
                Image {
                    source: {
                        ...
                        else if (index==2) (canDB.AVM_FrontView_Option==5)? systemInfo.imageInternal+"ico_radio_s.png" : systemInfo.imageInternal+"ico_radio_n.png"
                        else if (index==3) (canDB.AVM_FrontView_Option==2)? systemInfo.imageInternal+"ico_radio_s.png" : systemInfo.imageInternal+"ico_radio_n.png"
                        else if (index==4) (canDB.AVM_FrontView_Option==3)? systemInfo.imageInternal+"ico_radio_s.png" : systemInfo.imageInternal+"ico_radio_n.png"
                    }
                    anchors.verticalCenter: parent.verticalCenter
                    width: 45; height: 45
                }
            ...
            onClickOrKeySelected: {
                ...
                else if (index==2) canCon.changeAVMViewSettings(8); //Front 2-section view, DH PE
                else if (index==3) canCon.changeAVMViewSettings(1);
                else if (index==4) canCon.changeAVMViewSettings(0);
            }
...
//        boundsBehavior: Flickable.DragOverBounds //default : Flickable.DragAndOvershootBounds
...
//            }
        ...
        onMovementEnded: {
            //console.log("--- onMovementEnded0.1 - contentX : " , contentX )
            //console.log("--- onMovementEnded0.2 - contentY : " , contentY )
            //console.log("--- onMovementEnded0.3 - indexAt( contentX, contentY ) : " , indexAt( contentX, contentY ) )
            //console.log("--- onMovementEnded0.4 - before currentIndex : " , currentIndex )

            currentTopIndex = indexAt( contentX, contentY );

            if (currentTopIndex > currentIndex) {
                currentIndex = currentTopIndex;//positionViewAtIndex( currentIndex, ListView.Beginning);
                //console.log(" onMovementEnded -[down] positionViewAtIndex to currentIndex : " , currentIndex )
            }
            else if (currentIndex - currentTopIndex >=4) {
                positionViewAtIndex( currentIndex, ListView.Beginning);
                //console.log(" onMovementEnded -[up] positionViewAtIndex to currentIndex : " , currentIndex )
            }
            //else {
                //console.log(" onMovementEnded , else: Do nothing.")
            //}

            //console.log(" onMovementEnded After currentIndex : " , currentIndex )
        }

//        onContentYChanged : {
//            console.log(" onContentYChanged - contentY : " , contentY , ", contentX : " , contentX )
//        }
    ...
    Item
    {
        x: (cppToqml.IsArab)? 10 : systemInfo.righMenuItemButtonWidth+5; y:28
        width: scrollBar.width
        height: listView_frontInit.height - 25
        clip: true
        visible: true
        ...
        VerticalScrollBar
        {
            ...
            anchors.left: parent.left
            position: listView_frontInit.visibleArea.yPosition
            pageSize: listView_frontInit.visibleArea.heightRatio
        }
    }
