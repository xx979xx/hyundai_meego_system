...
DHAVN_AppSettings_FocusedItem{
    ...
    function setVisualCueOnMenu( itemNumber )
    {
        switch (itemNumber)
        {
        case APP.const_SETTINGS_SOUND_VOLUME_RATIO  : setVisualCue(true, false, false, true); visualCue.longkey_other = true;  break
        case APP.const_SETTINGS_SOUND_BALANCE       : setVisualCue(true, false, false, true); visualCue.longkey_other = true;  break
        case APP.const_SETTINGS_SOUND_TONES         : setVisualCue(true, false, false, true); visualCue.longkey_other = true;  break
        //case APP.const_SETTINGS_SOUND_SURROUND      : setVisualCue(true, false, false, false); visualCue.longkey_other = true; break
        ...
        case APP.const_SETTINGS_SOUND_SDVC          : setVisualCue(true, false, false, true); visualCue.longkey_other = true; break
        case APP.const_SETTINGS_SOUND_BEEP          : setVisualCue(true, false, false, false); visualCue.longkey_other = true; break
        case APP.const_SETTINGS_SOUND_RESET_ALL     : setVisualCue(true, false, false, false); visualCue.longkey_other = true; break
        case APP.const_SETTINGS_SOUND_QUANTUMLOGIC  : setVisualCue(true, false, false, true); visualCue.longkey_other = true; break // 2014.02.24 DH_PE Quantum logic
        }
    }
                ...
                if ( visible )
                {
                    if( status != Loader.Ready ){
                        if( SettingsStorage.currentRegion != 1 )
                            ...
                            source = "DHAVN_AppSettings_Sound_Tones_ForNA.qml"
                    }
                }
                else
                {
