...
MComponent
{
    ...
    property bool   firstTextBold: true//[ITS 0271270]
    ...
    property bool   seccondtickerAvailable: txtFocusSecondText.tickerAvailable
    ...
    onReleased: {
        ...
        console.log("## ~ Play Beep Sound(MButtonHaveTicker) ~ ##")
    ...
    Text {
        ...
        font.family: {
            if (true == container.active && false == container.activeFocus) {
                //[ITS 0271270]
                if(firstTextBold) stringInfo.fontFamilyBold //"HDB"
                else stringInfo.fontFamilyRegular
            } else {
            ...
            //container.activeFocus ? stringInfo.fontFamilyRegular : firstTextStyle
    ...
    DDScrollTicker {
        ...
        z: bgImageZ + 1
        width: firstTextWidth
        height: (firstTextStyle == stringInfo.fontFamilyRegular && firstTextSize < 39) ? firstTextHeight + 10 : firstTextHeight + 11
    ...
    Text {
        ...
        font.family: container.activeFocus ? stringInfo.fontFamilyRegular : secondTextStyle
    ...
    states: [
        State {
            ...
            PropertyChanges { target: txtSecondText;        color: container.activeFocus ? secondTextFocusColor : container.active ? secondTextSelectedColor : secondTextPressColor }
