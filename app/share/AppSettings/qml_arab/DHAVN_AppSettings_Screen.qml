...
DHAVN_AppSettings_FocusedItem{
    ...
    DHAVN_AppSettings_FocusedLoader
    {
        ...
        property string nested_state: APP.const_APP_SETTINGS_SCREEN_PE_ILLUMINATION_DAYLIGHT
        ...
        onStatusChanged:
        {
            if(status == Loader.Ready)
            {
                ...
                {
                    rootScreenMainLoader.item.state = APP.const_APP_SETTINGS_SCREEN_PE_ILLUMINATION_DAYLIGHT
        ...
        onVideoStatusChanged:
        {
            if(targetScreen == UIListener.getCurrentScreen())
            {
                if(enable)
                    ...
                    rootScreenMainLoader.nested_state = APP.const_APP_SETTINGS_SCREEN_PE_ILLUMINATION_DAYLIGHT
            }
        }
    }
}
