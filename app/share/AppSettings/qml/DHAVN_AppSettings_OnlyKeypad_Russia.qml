...
DHAVN_AppSettings_FocusedItem{
    ...
    function init()
    {
        ...
        console.log("kjw :: init() :: SettingsStorage.russianKeypad : ", SettingsStorage.russianKeypad)
    ...
    function setKeypadSettings(index)
    {
        ...
        SettingsStorage.SaveSetting( index, Settings.DB_KEY_RUSSIAN_KEYPAD )
        soundVolumeRatio.updateCurrentType(Settings.DB_KEY_RUSSIAN_KEYPAD)
        SettingsStorage.UpdateKeyboardData()
        EngineListener.NotifyApplication( Settings.DB_KEY_RUSSIAN_KEYPAD, index, "", UIListener.getCurrentScreen())
    }
    ...
    DHAVN_AppSettings_FocusedItem{
        ...
        DHAVN_AppSettings_FocusedItem{
            ...
            ListModel{
                ...
                ListElement{
                    title_of_radiobutton: QT_TR_NOOP("STR_SETTING_GENERAL_KEYPAD_QWERTY_RUS")//qsTranslate ("main", "STR_SETTING_SOUND_LOUDER_VOL_NAV") + LocTrigger.empty; //QT_TR_NOOP("STR_SETTING_SOUND_LOUDER_VOL_NAV")
                    enable: true
                }

                ListElement{
                    title_of_radiobutton: QT_TR_NOOP("STR_SETTING_GENERAL_KEYPAD_ABCD_RUS") //qsTranslate ("main", "STR_SETTING_SOUND_SAME_VOL") + LocTrigger.empty; //;QT_TR_NOOP("STR_SETTING_SOUND_SAME_VOL")
                    enable: true
                }
            }
    ...
    Connections{
        ...
        {
            console.log("kjw :: enter onRussianKeypadChanged !!!")
            init()
        }
    }
}
