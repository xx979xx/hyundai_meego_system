...
DHAVN_AppSettings_FocusedItem{
    ...
    Connections{
        ...
        onFrontScreenDaylightBrightnessChanged:
        {
            ...
            EngineListener.printLogMessage("onFrontScreenDaylightBrightnessChanged: " + SettingsStorage.frontScreenBrightness_Daylight)
            slider_low.rScrollCurrentValue = SettingsStorage.frontScreenBrightness_Daylight
            activeResetButton()
        }
        ...
        onRearScreenDaylightBrightnessChanged:
        {
            ...
            EngineListener.printLogMessage("onRearScreenDaylightBrightnessChanged: " + SettingsStorage.rearScreenBrightness_Daylight)
            slider_mid.rScrollCurrentValue = SettingsStorage.rearScreenBrightness_Daylight
            activeResetButton()
        }
