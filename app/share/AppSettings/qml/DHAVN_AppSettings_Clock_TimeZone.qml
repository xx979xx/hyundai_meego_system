...
DHAVN_AppSettings_FocusedItem{
    ...
    Connections{
        ...
        {
            //if(timeZoneMain.visible) //delete for ITS 219252 GPS Time zone list is not sync with current time.
            console.log("[QML] onAutoTimeZoneChanged :: SettingsStorage.gpsTime : " + SettingsStorage.gpsTime)
            if(SettingsStorage.gpsTime)
                init()
            //modify for ITS 219252 GPS Time zone list is not sync with current time.
        }
    }
}
