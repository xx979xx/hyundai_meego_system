...
#ifndef SESSIONPOWER_H_
#define SESSIONPOWER_H_
        ...
        class SessionPower
    {
        public :
            ...
            ~SessionPower();
               ...
               int handlePowerCmd(uint32_t cmd, uint32_t handle, uint8_t* pRxData, LinkController* pLnkCtrler);            

        private :
            void sendStartPowerUpdates(LinkController* pLnkCtrler, StartPowerUpdateArg* pArg);
            void sendStopPowerUpdates(LinkController* pLnkCtrler);
