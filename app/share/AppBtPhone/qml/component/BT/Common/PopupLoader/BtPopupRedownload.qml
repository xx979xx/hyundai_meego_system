/**
 * /BT/Common/PopupLoader/BtPopupRedownload.qml
 *
 */
import QtQuick 1.1
...
// __IQS_16MY
//        MOp.hidePopup();
        console.log("[16MY]contactState" + contactState );
        if(contactState == "ContactsWaitDownAuto" || recentCallState == "RecentWaitDownAuto"){
            //do nothing
        }
        else{
            MOp.hidePopup();
