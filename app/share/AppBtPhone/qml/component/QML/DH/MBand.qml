...
//        }
    ...
    Image {
        ...
        y: 0;
        z: 0;
        Image { source: ImagePath.imgFolderGeneral + "line_title.png"; x: 172; visible: idTabBtn1.visible}//idTabBtn1.visible }
        Image { source: ImagePath.imgFolderGeneral + "line_title.png"; x: 342; visible: idTabBtn2.visible}//idTabBtn2.visible }
        Image { source: ImagePath.imgFolderGeneral + "line_title.png"; x: 512; visible: idTabBtn3.visible}//idTabBtn3.visible }
        Image { source: ImagePath.imgFolderGeneral + "line_title.png"; x: 682; visible: idTabBtn4.visible}//idTabBtn4.visible }
    }
...
//    }
    ...
    DDImageButton {
        id: idBackBtn
        x: 1136 //sync with navi back button
        y: 0
        width: 141
        height: 72
