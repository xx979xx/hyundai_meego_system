...
*/
    ...
    onTabBtn3Clicked: {
        ...
        console.log("background = " + BtCoreCtrl.invokeGetBackgroundDownloadMode());
        console.log("contact_value = " + contact_value);
        if(true == iqs_15My && "" == popupState && true == BtCoreCtrl.invokeGetBackgroundDownloadMode()) {
            if(14 /* UPDATING */ == contact_value) {
