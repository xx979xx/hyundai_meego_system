...
class CongratulationWindow (InstallWindow):		
    ...
    def getScreen (self, anaconda):
        ...
        bootstr = ""
        floppystr = _("Now you can click the 'Close' button, and then unplug the "
                      "removable disk to reboot to the installed system.\n"
                      "Do not remove the USB key until you click 'Close'. "
                      "If you do remove it and your computer freezes, press the power button to restart.\n")
