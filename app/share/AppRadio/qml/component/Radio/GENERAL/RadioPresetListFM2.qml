...
FocusScope {
    ...
    visible: idAppMain.globalSelectedBand == "FM2"
    //enabled: idAppMain.globalSelectedBand == "FM2"
...
//            else if(value == 0 && idRadioPresetListFM2.requestStopSearch == true ){
//                console.log("onChangeSearchState requestStopSearch: " + idRadioPresetListFM2.requestStopSearch + idRadioPresetListFM2.requestStopIndex);
//                idRadioPresetListFM2.requestStopSearch = false;
//                QmlController.setPresetIndex(QmlController.radioBand,idRadioPresetListFM2.requestStopIndex)//QmlController.setPresetIndexFM1(idRadioPresetListFM2.requestStopIndex);
//                QmlController.presetRecall(idRadioPresetListFM2.requestStopIndex - 1,idRadioPresetListFM2.channelChangedFreq); // micom has index from 0 so it need to -1
//                idChListView.currentItem.calculateFrequencyInView();
//                idRadioPresetListFM2.requestStopIndex   = -1;
//                idRadioPresetListFM2.channelChangedFreq = "";
//            }
    ...
    Connections{
        ...
        onSignalUpdateModelData :{
         ...
         onSignalSetModelData :{
            if((idChListView.model == "") && (band  == 0x02))
                idChListView.model = PresetListFM2;
        }
    }
    ////
...
//                      //idAppMain.touchAmAniStop = true
        ...
        model : ""//PresetListFM2 //selectModel()
//        onCountChanged: {
...
// modified by qutiguy 2014.01.22 : modified position.
    ...
    /////////////////////////////////////////////////////////////////
    // idRadioPresetListFM2 functions
    ...
    function changeState(){
        ...
        if(idAppMain.globalSelectedBand =="FM2"){
            ...
            if((QmlController.presetIndexFM2 -1) < 0xF0){ // JSH Jog focus
                ...
                idRadioPresetListFM2.selectedItem = QmlController.presetIndexFM2 -1
            }
            else{
                idAppMain.alreadySaved         = 0
                idRadioPresetListFM2.selectedItem = QmlController.presetIndexFM2
            }
        }
        ...
        if((!idAppMain.doNotUpdate) && (idAppMain.state == "AppRadioMain" || (!idAppMain.globalMenuAnimation))){
            if(idRadioPresetListFM2.selectedItem < 12)
                idRadioMain.jogFocusState =  "PresetList"
            else
                idRadioMain.jogFocusState =  "FrequencyDial"
        }
...
//      }
    ...
    onActiveFocusChanged: { // JSH jog focus
        ...
        console.log("========================> PresetList onActiveFocusChanged :: ",idRadioPresetListFM2.activeFocus,idRadioMain.jogFocusState)
        if(idRadioMain.jogFocusState == "PresetList" && idAppMain.state == "AppRadioMain" && (!idRadioPresetListFM2.activeFocus))
            focus = true;
