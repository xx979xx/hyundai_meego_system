...
FocusScope{
    ...
    property bool isSeekPrevKeyLongPressed: false;
    property bool isSeekNextKeyLongPressed: false;
    property bool isJogEnterLongPressed: false;
    property bool isLongKeyExcept: false
    property string inputModeXM : "touch"
    ...
    Keys.onReleased: {
        ...
        case Qt.Key_Down:{
            ...
            if(downKeyPressed == true && downKeyLongPressed == false){ downKeyReleased = true; }
