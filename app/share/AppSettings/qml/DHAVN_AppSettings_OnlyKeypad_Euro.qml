...
DHAVN_AppSettings_FocusedItem{
    ...
    function init()
    {
        ...
        console.log("kjw :: init() :: SettingsStorage.europeKeypad : ", SettingsStorage.europeKeypad)
    ...
    function setKeypadSettings(index)
    {
        ...
        SettingsStorage.SaveSetting( index, Settings.DB_KEY_EUROPE_KEYPAD )
        soundVolumeRatio.updateCurrentType(Settings.DB_KEY_EUROPE_KEYPAD)
        SettingsStorage.UpdateKeyboardData()
        EngineListener.NotifyApplication( Settings.DB_KEY_EUROPE_KEYPAD, index, "", UIListener.getCurrentScreen())
    }
    ...
    Connections{
        ...
        {
            console.log("kjw :: enter onEuropeKeypadChanged !!!")
            init()
        }
    }
}
