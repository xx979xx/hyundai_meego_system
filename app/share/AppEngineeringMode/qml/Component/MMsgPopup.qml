...
MComponent { //jyjeon_20120221
    ...
    property string titleTextName: "HDB"
    ...
    property string msgTextName: "HDB"
    ...
    //--------------------- Button Text Info ##
    property int btnTextX: 80
    property int btnTextY: 20/*36*/
    property int btnTextSize: 30
    property string btnTextName: "HDB"
    property string btnTextAlies: "Left"
