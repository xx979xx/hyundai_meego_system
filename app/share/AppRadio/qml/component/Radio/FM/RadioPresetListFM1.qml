...
//                forceActiveFocus();
    ...
    Image{ // JSH 130706
        z: -1
        //source: showFocus && idRadioPresetListFM1.activeFocus ? imgFolderGeneral+"bg_menu_l_s.png" : ""//imgFolderGeneral+"bg_ch_l_n.png"
...
//        else return PresetListAM;
    ...
    function changeState(){
       ...
       console.log("=====>changeState(globalSelectedBand :: " , idAppMain.globalSelectedBand , "currentIndex :: ",idChListView.currentIndex,"selectedItem :: ",idRadioPresetListFM1.selectedItem ,idRadioMain.jogFocusState )
    }
