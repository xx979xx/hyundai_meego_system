...
class StorageDevice(Device):
    ...
    def fstabSpec(self):
        spec = self.path
        if self.format and self.format.uuid and self.removable:
...
class PartitionDevice(StorageDevice):
    ...
    def __init__(self, name, format=None,
        ...
        if grow and size and maxsize:
            if size == maxsize:
                grow = False
                log.info("Set grow to False as the size is equal to maxsize %d" % maxsize)
    ...
    def fstabSpec(self):
        ...
        elif self.format and self.format.uuid and self.removable:
            spec = "UUID=%s" % self.format.uuid
        return spec
...
class MDRaidArrayDevice(StorageDevice):
    ...
    def __init__(self, name, level=None, major=None, minor=None, size=None,
        ...
        if (not exists and parents and
            ...
            raise ValueError, _("A RAID%d set requires at least %d members") % (
