...
Item {
    ...
    function pressLeft ()
    {
        if (leftArrow)
        {
            visual_cue_bg.x = 555 //visual_cue_bg.x - moveValue
    ...
    function pressRight ()
    {
        if (rightArrow)
        {
            visual_cue_bg.x = 565 //visual_cue_bg.x + moveValue
    ...
    function pressUp ()
    {
        if (upArrow)
        {
            visual_cue_bg.y = 186 //visual_cue_bg.y - moveValue
    ...
    function pressDown ()
    {
        ...
        {
            visual_cue_bg.y = 196 //visual_cue_bg.y + moveValue
    ...
    function releaseLeft ()
    {
        if (moved)
        {
            visual_cue_bg.x = 560 //visual_cue_bg.x + moveValue
    ...
    function releaseUp ()
    {
        if (moved)
        {
            visual_cue_bg.y = 191 //visual_cue_bg.y + moveValue
