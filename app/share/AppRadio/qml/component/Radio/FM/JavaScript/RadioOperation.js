...
////
    ...
    case "AppRadioMain":{
        if( idRadioMain.status == Loader.Null )
            idRadioMain.source = "../component/Radio/FM/RadioMain.qml";
    ...
    case "AppRadioOptionMenu":{
        if( idRadioOptionMenu.status == Loader.Null )
            idRadioOptionMenu.source = "../component/Radio/FM/RadioOptionMenu.qml";
    ...
    //    case "PopupRadioPreset":{
    //        if( idRadioPopupPreset.status == Loader.Null )
    //            idRadioPopupPreset.source = "../component/Radio/FM/Popup/RadioPopupPreset.qml";

    //        idRadioPopupPreset.visible = true;
    //        idRadioPopupPreset.focus = true;
    //        idRadioPopupPreset.forceActiveFocus();
    //        break;
    //    }
//// 20130607 removed by qutiguy - no use.
//    case "PopupRadioPresetFull":{
//        if( idRadioPopupPresetFull.status == Loader.Null )
//            idRadioPopupPresetFull.source = "../component/Radio/FM/Popup/RadioPopupPresetFull.qml";

//        idRadioPopupPresetFull.visible = true;
//        idRadioPopupPresetFull.focus = true;
//        break;
//    }
//    case "PopupPresetWarning":{
//        if( idRadioPopupPresetWarning.status == Loader.Null )
//            idRadioPopupPresetWarning.source = "../component/Radio/FM/Popup/RadioPopupPresetWarning.qml";

//        idRadioPopupPresetWarning.visible = true;
//        idRadioPopupPresetWarning.focus = true;
//        break;
//    }
////
    case "PopupRadioDimAcquiring":{
        if( idRadioPopupDimAcquiring.status == Loader.Null )
            idRadioPopupDimAcquiring.source = "../component/Radio/FM/Popup/RadioPopupDimAcquiring.qml";
