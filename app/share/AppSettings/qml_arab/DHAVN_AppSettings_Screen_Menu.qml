...
DHAVN_AppSettings_FocusedItem{
    ...
    function setVisualCueOnMenu( index )
    {
        switch (index)
        {
        case 0: setVisualCue(true, false, true, false); visualCue.longkey_other = true; break
        case 1: setVisualCue(true, false, true, false); visualCue.longkey_other = true; break
        case 2: setVisualCue(true, false, true, false); visualCue.longkey_other = true; break
        case 3: setVisualCue(true, false, true, false); visualCue.longkey_other = true; break
        case 4: setVisualCue(true, false, false, false); visualCue.longkey_other = false; break
