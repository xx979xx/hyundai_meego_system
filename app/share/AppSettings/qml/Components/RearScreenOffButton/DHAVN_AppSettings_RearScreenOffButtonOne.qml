...
DHAVN_AppSettings_FocusedItem{
    ...
    width: HM.const_APP_SETTINGS_SCREEN_REAR_WIDTH
    height: HM.const_APP_SETTINGS_SCREEN_REAR_HEIGHT
    ...
    Image{
        ...
        visible: rearScreenButton1.focus_visible && (!btn_p.visible)
    }
    ...
    Text{
        ...
        visible: !SettingsStorage.RightRearScreen
    }
    ...
    Connections{
        ...
        onRightRearScreenChanged:  {
            if (SettingsStorage.RightRearScreen) rearOn()
            else rearOff()
        }
    }
}
