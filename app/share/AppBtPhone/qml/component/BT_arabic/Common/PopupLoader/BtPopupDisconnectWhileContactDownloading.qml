/**
 * /BT_arabic/Common/PopupLoader/BtPopupDisconnectWhileContactDownloading.qml
 *
 */
import QtQuick 1.1
...
{
    id: idBtPopupDisconnectWhileContactDownloading

    popupBtnCnt: 2
    popupLineCnt: 1
    black_opacity: true

    popupFirstText: stringInfo.str_Phonebook_Downloading_Dis_Connect
