...
unless (defined &__INT32_C(c)) { sub __INT32_C(c)() { &c } }
...
unless (defined &__UINT32_C(c)) { sub __UINT32_C(c)() { &cU } }
...
unless (defined &__UINT64_C(c)) { sub __UINT64_C(c)() { &cULL } }
...
unless (defined &__VERSION__) { sub __VERSION__() { "\"4\.5\.1\\\ 20100731\\\ \(MeeGo\\\ 4\.5\.1\-1\)\\\ \[release\\\ 4\.5\-2010\.09\-1\]\"" } }
...
unless (defined &__core2) { sub __core2() { 1 } }

unless (defined &__core2__) { sub __core2__() { 1 } }
...
unless (defined &__tune_atom__) { sub __tune_atom__() { 1 } }
