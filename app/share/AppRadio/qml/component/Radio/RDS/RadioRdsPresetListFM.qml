/**
 * FileName: RadioRdsPresetListFM.qml
 * Author: HYANG
 * Time: 2012-06
 *
...
MComp.MComponent {
    ...
    onVisibleChanged: {
        ...
        console.log(" [RadioRdsPresetListFM][idRadioRdsPresetListFM][onVisibleChanged] " + idRadioRdsPresetListFM.visible)
        console.log(" [RadioRdsPresetListFM][idRadioRdsPresetListFM][onVisibleChanged] selectedIndex = " + idRadioRdsPreset.selectedIndex)
        if(visible) {
    ...
    onActiveFocusChanged: {
        if(idAppMain.globalSelectedBand == 0x03)
            return;
        console.log(" [RadioRdsPresetListFM][idRadioRdsPresetListFM][onActiveFocusChanged] " )
        if(activeFocus)
        {
            //KSW 140515-1
            if(b_presetsavemode != true)
    ...
    Connections{
        ...
        onChannelChanged:{
            ...
            if(idRadioRdsPresetListFM.visible)
                signalRestartTimerPresetList();
...
//                        return;
        ...
        onSignalIsManualTune: {
            ...
            console.log(" [PresetList][idRadioRdsPresetListFM][onSignalIsManualTune] "+bIsManualTune )
