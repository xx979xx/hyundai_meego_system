...
DHAVN_AppSettings_FocusedItem{
    ...
    function setVisualCueOnMenu( index )
    {
        switch (index)
        {
        case 0: setVisualCue(true, false, systemInfoLoader.is_focusMovable, false); visualCue.longkey_other = true; break
        case 1: setVisualCue(true, false, jukeBoxInfoLoader.is_focusMovable, false); visualCue.longkey_other = true; break
        //case 2: setVisualCue(true, false, false, false); break
        case 2: setVisualCue(true, false, upgradeLoader.is_focusMovable, false); visualCue.longkey_other = true; break
