/**
 * FileName: RadioRdsPresetListAM.qml
 * Author: HYANG
 * Time: 2012-06
 *
...
MComp.MComponent {
    ...
    onVisibleChanged: {
        ...
        console.log(" [RadioRdsPresetList][idRadioRdsPresetListAM][onVisibleChanged] " + idRadioRdsPresetListAM.visible)
        console.log(" [RadioRdsPresetList][idRadioRdsPresetListAM][onVisibleChanged] selectedIndex = " + idRadioRdsPreset.selectedIndex)
        if(visible) {
    ...
    onActiveFocusChanged: {
        if(idAppMain.globalSelectedBand == 0x01)
            return;
        console.log(" [RadioRdsPresetListAM][idRadioRdsPresetListAM][onActiveFocusChanged] " )
        if(activeFocus)
        {
            //KSW 140515-1
            if(b_presetsavemode != true)
    ...
    Connections{
        ...
        onChannelChanged:{
            ...
            if(idRadioRdsPresetListAM.visible)
                signalRestartTimerPresetList();
...
//                        return;
        ...
        onSignalIsManualTune: {
            ...
            console.log(" [PresetList][idRadioRdsPresetListAM][onSignalIsManualTune] "+bIsManualTune )
