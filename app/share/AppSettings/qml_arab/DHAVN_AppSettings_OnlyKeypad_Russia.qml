    ...
    DHAVN_AppSettings_FocusedItem{
        ...
        DHAVN_AppSettings_FocusedItem{
            ...
            ListModel{
                ...
                ListElement{
                    title_of_radiobutton: QT_TR_NOOP("STR_SETTING_GENERAL_KEYPAD_QWERTY")//qsTranslate ("main", "STR_SETTING_SOUND_LOUDER_VOL_NAV") + LocTrigger.empty; //QT_TR_NOOP("STR_SETTING_SOUND_LOUDER_VOL_NAV")
                    enable: true
                }

                ListElement{
                    title_of_radiobutton: QT_TR_NOOP("STR_SETTING_GENERAL_KEYPAD_ABCD") //qsTranslate ("main", "STR_SETTING_SOUND_SAME_VOL") + LocTrigger.empty; //;QT_TR_NOOP("STR_SETTING_SOUND_SAME_VOL")
                    enable: true
                }
            }
