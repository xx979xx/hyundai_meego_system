...
MComp.MComponent
{
        ...
        if("" == favoriteAdd) {
            ...
            if(9 < BtCoreCtrl.m_nCountFavoriteContactsList) {
                ...
                if(false == favoriteButtonPress) {
                    ...
                    BtCoreCtrl.invokeTrackerAddFavoriteFromPhonebook(add_favorite_index, type, number);
                } else {
    ...
    MComp.MButtonHaveTicker {
        ...
        onWheelRightKeyPressed: btn_contact3_1.forceActiveFocus()
        onWheelLeftKeyPressed: {
/*DEPRECATED
            if(delegate_count == 2) {
                btn_contact3_1.forceActiveFocus()
...
DEPRECATED*/
    ...
    MComp.MButtonHaveTicker {
        ...
        onWheelRightKeyPressed: btn_contact3_2.forceActiveFocus()
        onWheelLeftKeyPressed: {
/*DEPRECATED
...
DEPRECATED*/
    ...
    MComp.MButtonHaveTicker {
        ...
        onWheelRightKeyPressed: btn_contact3_4.forceActiveFocus()
        onWheelLeftKeyPressed: {
            //btn_contact3_1.forceActiveFocus();
        }
