...
MComponent
{
    ...
    Image {
        ...
        FocusScope {
            ...
            Component {
                ...
                MButton {
                    ...
                    onWheelLeftKeyPressed: idSearchContacts.decrementCurrentIndex()
                    onWheelRightKeyPressed: idSearchContacts.incrementCurrentIndex()
                    ...
                    onClickOrKeySelected: {
                        ...
                        if("" == favoriteAdd) {
                            ...
                            if(index == 0) {
                                ...
                                BtCoreCtrl.invokeTrackerAddFavoriteFromSearch(first_name, last_name, formatted_name, contact_type_5, other2Num )
                            }
                        }
                    }
        ...
        MButton {
            ...
            fgImageWidth: 69
            fgImageHeight: 69
            fgImageVisible: (idButton1.activeFocus == true) ? true : false
