...
public:
    ...
    void saveReservationItem(QString fileName);
    void loadReservationItem(void);
    bool loadCheckSumReservationItem(QString fileName);
    void saveNormalEPG(QString fileName);
    void saveCheckSumEPG(QString fileName);
