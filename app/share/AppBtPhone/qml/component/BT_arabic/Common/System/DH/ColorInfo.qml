...
Item 
{
    ...
    //DEPRECATED property color focusGrey:       Qt.rgba( 72/255,  72/255,  72/255, 1)
    property color buttonGrey:      Qt.rgba( 47/255,  47/255,  47/255, 1)
    //DEPRECATED property color progressBlue:    Qt.rgba(  0/255, 135/255, 239/255, 1)
    //DEPRECATED property color dimmedBlue:      Qt.rgba( 68/255, 124/255, 173/255, 1)
    property color bandBlue:        Qt.rgba(124/255, 189/255, 255/255, 1)
