...
Item
{
  ...
  //  QwertyKeypadUtility{id: translate}
     ...
     Column
    {
        ...
        Repeater
        {
            model: translate.keypadTypeEn == 0 ? english_qwerty_keypad_model.keypad : english_abcd_keypad_model.keypad
            delegate: keypad_row
        }
            ...
            Row
            {
                ...
                Repeater
                {
                    ...
                    DHAVN_QwertyKeypad_Button
                    {
                        ...
                        transitionIndex: (countryVariant == 1) ? trn_index : trn_index2

                        property int keycode: btn_keycode
...
//                            if ( btn_keycode != Qt.Key_Shift )
    ...
    {
        translate.changeLang( "English", translate.keypadTypeEn, shiftMode !=  e_SHIFT_NONE)
        ...
        if (countryVariant == 0)   // korean keypad
        {
    ...
    {
        return translate.keypadTypeEn == 0 ? english_qwerty_keypad_model.btn_count - 1 : english_abcd_keypad_model.btn_count - 1;
    }
...
//                    else if(curKey.suffix.substr(curKey.suffix.indexOf("_")+1, curKey.suffix.length) == "space")
//                    {
//                        console.log("----------------------------------------------"+flag);
//                        if(flag & 0xe0000000)
//                            curKey.disableForIntelliKeyboard = false;
