...
//                forceActiveFocus();
    ...
    Image{ // JSH 130706
        z: -1
        //source: showFocus && idRadioPresetListFM2.activeFocus ? imgFolderGeneral+"bg_menu_l_s.png" : ""//imgFolderGeneral+"bg_ch_l_n.png"
...
//        else return PresetListAM;
    ...
    function changeState(){
       ...
       console.log("=====>changeState(globalSelectedBand :: " , idAppMain.globalSelectedBand , "currentIndex :: ",idChListView.currentIndex,"selectedItem :: ",idRadioPresetListFM2.selectedItem ,idRadioMain.jogFocusState )
    }
