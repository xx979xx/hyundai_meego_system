...
DHAVN_AppSettings_FocusedItem{
    ...
    PopUpText{
        ...
        onBtnClicked:
        {
            ...
            case "OkId":
            {
                closePopUp(true, Settings.SETTINGS_RESET_GENERAL_SETTINGS)
            }
            break

            case "CancelId":
            {
                closePopUp(false, Settings.SETTINGS_RESET_GENERAL_SETTINGS)
            }
            break
            }
        }
    ...
    ListModel{
        id: messageModel
        ListElement{
            msg: QT_TR_NOOP("STR_SETTING_INITIALIZE_ALL_RESET_INFO")
        }
    }
}
