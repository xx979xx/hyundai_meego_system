...
MComp.MOptionMenu{
    ...
    menu2Enabled : ((PLAYInfo.Advisory == "STR_XMRADIO_PREPAIRING_MESSAGE") || (PLAYInfo.SubAdvisory == "STR_XMRADIO_ANTENNA_DISCONNECTED") || (PLAYInfo.SubAdvisory == "STR_XMRADIO_ANTENNA_SHORTED") || (PLAYInfo.SubAdvisory == "STR_XMRADIO_LOSS_OF_SIGNAL") || (PLAYInfo.SubAdvisory == "STR_XMRADIO_ACQUIRING_SIGNAL") || (PLAYInfo.SubAdvisory == "STR_XMRADIO_BUSY")) ? false : true
    ...
    function setOptionMenuModelString(){
        ...
        var data3 = {"name" : stringInfo.sSTR_XMRADIO_PRESET_SCAN, "opType":""};
        var data4 = {"name" : stringInfo.sSTR_XMRADIO_SCAN_ALL_CHANNELS, "opType":""};
        var data5 = {"name" : stringInfo.sSTR_XMRADIO_DIRECT_TUNE, "opType":""};
        var data6  = {"name" : stringInfo.sSTR_XMRADIO_FEATURED_FAVORITE, "opType":""};
        ...
        if (gSXMPresetScan == "PresetScan") {
            data3 = {"name" : stringInfo.sSTR_XMRADIO_STOP_SCAN, "opType":""};
        }
        else if (gSXMScan == "Scan") {
