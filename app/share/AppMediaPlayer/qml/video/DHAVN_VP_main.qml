...
//{chagned by junam 2013.09.30 for change raster
//TransparencyPainter
Item //}changed by juanm
{
    ...
    Connections
    {
        ...
        onBlackVideoOnFront:
        {
            EngineListenerMain.qmlLog("[MP] [QML] DHAVN_VP_main :: onBlackVideo : bHide = ", bHide)
...
// { added by yungi 2013.10.10 for ITS 194869
    Connections
    {
        ...
        onSetModeAreaOnlyBgFront:
        {
            EngineListenerMain.qmlLog("[MP] [QML] DHAVN_VP_main :: onSetModeAreaOnlyBgFront : bDimOn = ", bDimOn)
...
//       }
    ...
    */
    ...
    Component.onCompleted : {
        EngineListener.notifyComplete(main, true);
    }
}
