...
Item 
{
    ...
    property string bgImage: ImagePath.imgFolderGeneral + "scroll_menu_list_bg.png"

    property string topScrollImage:     ImagePath.imgFolderGeneral + "scroll_t.png"
    property string middleScrollImage:  ImagePath.imgFolderGeneral + "scroll_m.png"
    property string bottomScrollImage:  ImagePath.imgFolderGeneral + "scroll_b.png"
    ...
    function size() {
        ...
        if(ny < 0) {
            ...
            height = idMScroll.height - position() - imgBottomScroll.height + 5;
        } else {
            if(40 > height ) {
                height = 40;
            }
