...
import "../component/Radio/GENERAL" as MRadio
import "../component/Radio/GENERAL/JavaScript/RadioOperation.js" as MOperation
...
//    property bool presetEditEnabled : false // JSH 121121 , preset list Edit button on /off
    ...
    property bool   globalMenuAnimation : idRadioOptionMenu.status == Loader.Null ? false : idRadioOptionMenu.item.menuAnimation

    property bool  generalMirrorMode : stringInfo.langId == 20 ? true : false// JSH 130612 ME
   ...
   onStateChanged: {
    ...
    QmlStatusBar{
        ...
        height: 93
        homeType:"button"
        middleEast: stringInfo.langId == 20 ? true:false;
        visible:true
/*
    eCVInvalid      = -1,
    eCVKorea        =  0,
