...
DHAVN_AppSettings_FocusedItem {
    ...
    function checkRearMonitor()
    {
        if(EngineListener.dcSwapped)
        {
            ...
            EngineListener.printLogMessage("[RSC]Swap Case: " + currentTargetScreen + UIListener.getCurrentScreen());
        ...
        {
            //added for ITS 248636 Rear Seat Control UI Issue
            EngineListener.printLogMessage("[RSC]Normal Case: " + currentTargetScreen + UIListener.getCurrentScreen());
    ...
    DHAVN_AppSettings_FocusedItem{
        ...
        is_focusMovable: EngineListener.isAccStatusOn
        visible: SettingsStorage.rearRRCVariant && checkRearMonitor() //added for Rear Seat Control Spec Update
        ...
        Image{
            ...
            anchors.left:parent.left
            anchors.leftMargin: (EngineListener.isAccStatusOn)? 492:493
        }
