...
static inline rtx gen_atomic_compare_and_swap_singledi  (rtx, rtx, rtx, rtx);
static inline rtx
gen_atomic_compare_and_swap_singledi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
extern rtx        gen_atomic_compare_and_swap_doubledi  (rtx, rtx, rtx, rtx, rtx, rtx, rtx);
static inline rtx gen_atomic_compare_and_swap_doubleti  (rtx, rtx, rtx, rtx, rtx, rtx, rtx);
static inline rtx
gen_atomic_compare_and_swap_doubleti(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d), rtx ARG_UNUSED (e), rtx ARG_UNUSED (f), rtx ARG_UNUSED (g))
{
  return 0;
}
