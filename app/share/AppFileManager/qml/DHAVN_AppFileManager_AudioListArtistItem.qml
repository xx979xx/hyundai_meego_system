...
Item
{
   ...
   height: FM.const_APP_FILE_MANAGER_AUDIO_ARTIST_LIST_ITEM_HEIGHT
   width: parent.width
   ...
   Image
   {
      ...
      anchors { left: parent.left; top: parent.top }
      anchors.leftMargin: FM.const_APP_FILE_MANAGER_AUDIO_ARTIST_ICON_LEFT_MERGIN
   ...
   Text
   {
      ...
      anchors.leftMargin: FM.const_APP_FILE_MANAGER_AUDIO_ARTIST_TEXT_LEFT_MERGIN
