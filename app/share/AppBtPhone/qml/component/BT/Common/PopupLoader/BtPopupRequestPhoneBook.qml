...
MComp.MPopupTypeText
{
    ...
    popupBtnCnt: 1
    popupFirstText: (0 == UIListener.invokeGetVehicleVariant())? stringInfo.str_Req_Down_Phonebook + ' ' + stringInfo.str_Accept_Phone_Popup : (2 == gLanguage)? stringInfo.str_Req_Down_Phonebook + '\n' + stringInfo.str_Accept_Phone_Popup : stringInfo.str_Req_Down_Phonebook + ' ' + stringInfo.str_Accept_Phone_Popup
    popupFirstBtnText: stringInfo.str_Close;
    popupLineHeight: (gLanguage == 21 || gLanguage == 22)? 0.9 : 1
