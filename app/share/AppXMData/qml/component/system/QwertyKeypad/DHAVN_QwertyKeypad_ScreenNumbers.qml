...
Item
{
   ...
   Column
   {
      ...
      Repeater
      {
         model: numeric_keypad_model.keypad
         delegate: keypad_row
      }
      ...
      Component
      {
         ...
         Row
         {
             ...
             Repeater
            {
               ...
               {
                  btnid: btn_id; width: btn_width; height: btn_height; suffix: btn_suffix; keytext: btn_text
                  ...
                  {
                      console.log("/home/meego/intelliKeyboard/DHAVN_QwertyKeypadWidget/qml/DHAVN_QwertyKeypad_ScreenNumbers.qml")
    ...
    function retranslateUi()
    {
        ...
        if (countryVariant == 0)   // korean keypad
        {
            ...
            column.children[3].children[1].disableForIntelliKeyboard = true;
    ...
    {
        return numeric_keypad_model.btn_count - 1
    }
