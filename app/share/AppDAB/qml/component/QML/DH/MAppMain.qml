...
FocusScope{
    ...
    property bool seekPrevLongKeyPressed: false
    property bool seekNextLongKeyPressed: false
    property bool bSeekPrevKeyPressed: false;
    property bool bSeekNextKeyPressed: false;
    property bool bSeekPrevKeyReleased: false;
    property bool bSeekNextKeyReleased: false;
...
//        case Qt.Key_Equal:{
        ...
        case Qt.Key_Q:{
            if(event.modifiers == Qt.ShiftModifier){
                event.accepted = true
                seekPrevLongKeyPressed = true;
            }
            else{
                bSeekPrevKeyPressed = true;
                bSeekPrevKeyReleased = false;
            }
            break;
        }
        case Qt.Key_W:{
            if(event.modifiers == Qt.ShiftModifier){
                event.accepted = true
                seekNextLongKeyPressed = true;
            }
            else{
                bSeekNextKeyPressed = true;
                bSeekNextKeyReleased = false;
            }
            break;
        }
    ...
    Keys.onReleased: {
        ...
        case Qt.Key_Up:{
            ...
            if(upKeyPressed == true && upKeyLongPressed == false){ upKeyReleased = true; }
...
//        case Qt.Key_Equal:{
        ...
        case Qt.Key_Q:{
            if(bSeekPrevKeyPressed == true && seekPrevLongKeyPressed == false){ bSeekPrevKeyReleased = true; }

            bSeekPrevKeyPressed = false;
            seekPrevLongKeyPressed = false;
            break;
        }
        case Qt.Key_W:{
            if(bSeekNextKeyPressed == true && seekNextLongKeyPressed == false){ bSeekNextKeyReleased = true; }

            bSeekNextKeyPressed = false;
            seekNextLongKeyPressed = false;
            break;
        }
        default:
            break;
...
//        if(event.key == Qt.Key_Equal){
    ...
    function isSeekLongCheckForceRelease()
    {
        if(seekNextLongKeyPressed){
            bSeekNextKeyPressed = false;
            seekNextLongKeyPressed = false;
        }
        else if(seekPrevLongKeyPressed){
            bSeekPrevKeyPressed = false;
            seekPrevLongKeyPressed = false;
        }
    }
