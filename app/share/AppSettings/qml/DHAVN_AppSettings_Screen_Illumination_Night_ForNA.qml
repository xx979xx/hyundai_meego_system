...
DHAVN_AppSettings_FocusedItem{
    ...
    function init()
    {
        slider_low.rScrollCurrentValue = SettingsStorage.frontScreenBrightness_Night
        slider_mid.rScrollCurrentValue = SettingsStorage.rearScreenBrightness_Night
    ...
    {
        if( slider_low.rScrollCurrentValue== illuminationNightMain.const_APP_SETTINGS_DEFAULT_IMAGE_BRIGHTNESS &&
                slider_mid.rScrollCurrentValue == illuminationNightMain.const_APP_SETTINGS_DEFAULT_IMAGE_BRIGHTNESS )
    ...
    function saveFrontBrightnessDB()
    {
        ...
        SettingsStorage.frontScreenBrightness_Night = Math.floor(slider_low.rScrollCurrentValue)

        EngineListener.NotifyDisplayNightBrightnessChange(1, Math.floor(slider_low.rScrollCurrentValue)+ 5)
    ...
    function saveRearBrightnessDB()
    {
        ...
        SettingsStorage.rearScreenBrightness_Night = Math.floor(slider_mid.rScrollCurrentValue)

        EngineListener.NotifyDisplayNightBrightnessChange(0, Math.floor(slider_mid.rScrollCurrentValue) + 5)
    ...
    Timer{
        ...
        running: false
        repeat: false
        onTriggered: illuminationNightMain.saveFrontBrightnessDB()
    }
    ...
    Timer{
        ...
        running: false
        repeat: false
        onTriggered: illuminationNightMain.saveRearBrightnessDB()
    }
    ...
    DHAVN_AppSettings_FocusedItem{
        ...
        ScrollingTicker {
            ...
            anchors.verticalCenterOffset: -119//-117
            anchors.left:parent.left
        ...
        DHAVN_AppSettings_SI_CenterScrollBarForNAScreen{
            id: slider_low
            property string name: "SliderLow"
            anchors.verticalCenter: parent.bottom
            anchors.verticalCenterOffset: -60//-55
            ...
            rScrollCurrentValue: SettingsStorage.frontScreenBrightness_Night - 5
            ...
            onSwitchPressed:
            {
                ...
                if(!SettingsStorage.rearMonitor)
                {
                    if(resetbutton.active)
                        rootScreen.setVisualCue(true, true, true, false)
                    else
                        rootScreen.setVisualCue(true, false, true, false)
                }

                illuminationNightMain.currentOption = 0
                setTimer()
            }

            onTouch:
            {
                illuminationNightMain.hideFocus()
                parent.setFocusHandle(0, 0)
                illuminationNightMain.showFocus()
            }
        }
    ...
    DHAVN_AppSettings_FocusedItem{
        ...
        DHAVN_AppSettings_SI_CenterScrollBarForNAScreen{
            ...
            rScrollValueMax:  HM.const_APP_SETTINGS_SCREEN_BRIGHTNESS_MAX_VALUE
            rScrollValueMin:  HM.const_APP_SETTINGS_SCREEN_BRIGHTNESS_MIN_VALUE
            rScrollCurrentValue: SettingsStorage.rearScreenBrightness_Night - 5
            ...
            onSwitchPressed:
            {
                ...
                illuminationNightMain.currentOption = 1
                setTimer()
            }
    ...
    DHAVN_AppSettings_ResetButton{
        ...
        function reset()
        {
            SettingsStorage.frontScreenBrightness_Night = illuminationNightMain.const_APP_SETTINGS_DEFAULT_IMAGE_BRIGHTNESS
            SettingsStorage.SaveSetting( illuminationNightMain.const_APP_SETTINGS_DEFAULT_IMAGE_BRIGHTNESS + 5,Settings.DB_KEY_FRONT_SCREENBRIGHTNESS_NIGHT )
            EngineListener.NotifyApplication( Settings.DB_KEY_FRONT_SCREENBRIGHTNESS,
                                             illuminationNightMain.const_APP_SETTINGS_DEFAULT_IMAGE_BRIGHTNESS + 5,
                                             "",   UIListener.getCurrentScreen())
            EngineListener.NotifyDisplayNightBrightnessChange(1, illuminationNightMain.const_APP_SETTINGS_DEFAULT_IMAGE_BRIGHTNESS + 5)

            SettingsStorage.rearScreenBrightness_Night = illuminationNightMain.const_APP_SETTINGS_DEFAULT_IMAGE_BRIGHTNESS
            SettingsStorage.SaveSetting( illuminationNightMain.const_APP_SETTINGS_DEFAULT_IMAGE_BRIGHTNESS + 5 ,Settings.DB_KEY_REAR_SCREENBRIGHTNESS_NIGHT )
            EngineListener.NotifyApplication( Settings.DB_KEY_REAR_SCREENBRIGHTNESS,
                                             illuminationNightMain.const_APP_SETTINGS_DEFAULT_IMAGE_BRIGHTNESS + 5,
                                             "",   UIListener.getCurrentScreen())
            EngineListener.NotifyDisplayNightBrightnessChange(0, illuminationNightMain.const_APP_SETTINGS_DEFAULT_IMAGE_BRIGHTNESS + 5)

            slider_low.rScrollCurrentValue = SettingsStorage.frontScreenBrightness_Night
            slider_low.leftCount = 5
            slider_low.rightCount = 0
            slider_mid.rScrollCurrentValue = SettingsStorage.rearScreenBrightness_Night
            slider_mid.leftCount = 5
    ...
    Connections{
        ...
        onFrontScreenNightBrightnessChanged:
        {
        ...
        onRearScreenNightBrightnessChanged:
        {
        ...
        onResetSliderGUIForNA:{
            EngineListener.printLogMessage("[Screen]onResetSliderGUIForNA -------------");
            slider_low.leftCount = 5
            slider_low.rightCount = 0
