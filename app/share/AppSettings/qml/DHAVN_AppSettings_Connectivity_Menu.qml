...
DHAVN_AppSettings_FocusedItem{
    ...
    function setVisualCueOnMenu( index )
    {
        ...
        {
        case APP.const_SETTINGS_CONNECTIVITY_IOS                       : setVisualCue(true, false, false, true); visualCue.longkey_other = true;  break
        case APP.const_SETTINGS_CONNECTIVITY_ANDROID                  : setVisualCue(true, false, false, true); visualCue.longkey_other = true;  break
