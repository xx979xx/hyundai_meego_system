...
DHAVN_AppSettings_FocusedItem{
    ...
    function setVisualCueOnMenu( index )
    {
        ...
        case APP.const_SETTINGS_CLOCK_TIME_ZONE       : setVisualCue(true, false, true, false); visualCue.longkey_other = true;  break
        case APP.const_SETTINGS_CLOCK_CLOCK_TYPE      : setVisualCue(true, false, true, false); visualCue.longkey_other = true;  break
        case APP.const_SETTINGS_CLOCK_TIME_FORMAT     : setVisualCue(true, false, true, false); visualCue.longkey_other = false;  break
        }
    }
    ...
    ListModel{
        ...
        function setItems()
        {
            ...
            if( (isNa) && ( !SettingsStorage.gpsTime || !SettingsStorage.isNaviVariant || !SettingsStorage.naviSDCard) )
            {
