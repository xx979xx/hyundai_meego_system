...
//        else return PresetListAM;
    ...
    function changeState(){
       ...
       console.log("=====>changeState(globalSelectedBand :: " , idAppMain.globalSelectedBand , "currentIndex :: ",idChListView.currentIndex,"selectedItem :: ",idRadioPresetList.selectedItem ,idRadioMain.jogFocusState )
    }
