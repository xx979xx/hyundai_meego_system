...
DHAVN_AppSettings_FocusedItem{
    ...
    function init()
    {
        ...
        console.log("kjw :: init() :: SettingsStorage.englishKeypad : ", SettingsStorage.englishKeypad)
    ...
    function setKeypadSettings(index)
    {
        ...
        SettingsStorage.SaveSetting( index, Settings.DB_KEY_ENGLISH_KEYPAD )
        soundVolumeRatio.updateCurrentType(Settings.DB_KEY_ENGLISH_KEYPAD)
        SettingsStorage.UpdateKeyboardData()
        EngineListener.NotifyApplication( Settings.DB_KEY_ENGLISH_KEYPAD, index, "", UIListener.getCurrentScreen())
    }
    ...
    Connections{
        ...
        {
            console.log("kjw :: enter onEnglishKeypadChanged !!!")
            init()
        }
    }
}
